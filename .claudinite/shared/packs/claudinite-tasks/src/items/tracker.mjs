...
import { searchIssues, patchIssue, postIssue, setIssueBody, comment as postComment } from '../world/github.mjs';
...
export async function writeTracker(gh, repo, number, { body, comment = null } = {}) {
  ...
  if (comment) {
    const posted = await postComment(gh, repo, number, comment);
