...
// a marked issue keeps its own human title and names its task in the
...
// The pick order: urgent first, then RANDOM among the ready, with
...
//    nothing) - and neither does one sitting `needs-human`: a broken
...
// occurrence or an ad-hoc run. `random` is the tie-break draw, injected
